...
c?g[b]:g[b]&&b;if(n&&d[n]&&(K||d[n].data)||!(void 0===p&&"string"===typeof a)){n||(n=c?g[b]=j.pop()||f.guid++:b);d[n]||(d[n]=c?{}:{toJSON:f.noop});if("object"===typeof a||"function"===typeof a)K?d[n]=f.extend(d[n],a):d[n].data=f.extend(d[n].data,a);g=d[n];K||(g.data||(g.data={}),g=g.data);void 0!==p&&(g[f.camelCase(a)]=p);"string"===typeof a?(p=g[a],null==p&&(p=g[f.camelCase(a)])):p=g;return p}}}function c(g,a,p){if(f.acceptData(g)){var K,b,c=g.nodeType,j=c?f.cache:g,d=c?g[f.expando]:f.expando;if(j[d]){if(a&&
(K=p?j[d]:j[d].data)){f.isArray(a)?a=a.concat(f.map(a,f.camelCase)):a in K?a=[a]:(a=f.camelCase(a),a=a in K?[a]:a.split(" "));for(b=a.length;b--;)delete K[a[b]];if(p?!u(K):!f.isEmptyObject(K))return}if(!p&&(delete j[d].data,!u(j[d])))return;c?f.cleanData([g],!0):w.deleteExpando||j!=j.window?delete j[d]:j[d]=null}}}function d(){return!0}function q(){return!1}function I(){try{return y.activeElement}catch(g){}}function B(g){var a=mc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
...
!0;v<p;v++)r.tweens[v].run(1);a?n.resolveWith(g,[r,a]):n.rejectWith(g,[r,a]);return this}});a=r.props;p=r.opts.specialEasing;var q,h,l,k;for(b in a)if(q=f.camelCase(b),h=p[q],l=a[b],f.isArray(l)&&(h=l[1],l=a[b]=l[0]),b!==q&&(a[q]=l,delete a[b]),(k=f.cssHooks[q])&&"expand"in k)for(b in l=k.expand(l),delete a[q],l)b in a||(a[b]=l[b],p[b]=h);else p[q]=h;for(;j<d;j++)if(b=tb[j].call(r,g,a,r.opts))return b;f.map(a,wa,r);f.isFunction(r.opts.start)&&r.opts.start.call(g,r);f.fx.timer(f.extend(e,{elem:g,anim:r,
queue:r.opts.queue}));return r.progress(r.opts.progress).done(r.opts.done,r.opts.complete).fail(r.opts.fail).always(r.opts.always)}function kb(g){return function(a,p){"string"!==typeof a&&(p=a,a="*");var b,c=0,j=a.toLowerCase().match(xa)||[];if(f.isFunction(p))for(;b=j[c++];)"+"===b.charAt(0)?(b=b.slice(1)||"*",(g[b]=g[b]||[]).unshift(p)):(g[b]=g[b]||[]).push(p)}}function ub(g,a,p,b){function c(n){var e;j[n]=!0;f.each(g[n]||[],function(g,f){var n=f(a,p,b);if("string"===typeof n&&!d&&!j[n])return a.dataTypes.unshift(n),
c(n),!1;if(d)return!(e=n)});return e}var j={},d=g===Nb;return c(a.dataTypes[0])||!j["*"]&&c("*")}function ya(g,a){var p,b,c=f.ajaxSettings.flatOptions||{};for(b in a)void 0!==a[b]&&((c[b]?g:p||(p={}))[b]=a[b]);p&&f.extend(!0,g,p);return g}function na(g,a,p,b){var c;if(f.isArray(a))f.each(a,function(a,v){p||ad.test(g)?b(g,v):na(g+"["+("object"===typeof v?a:"")+"]",v,p,b)});else if(!p&&"object"===f.type(a))for(c in a)na(g+"["+c+"]",a[c],p,b);else b(g,a)}function C(g){try{return g?new a.ActiveXObject("Microsoft.XMLHTTP"):
new a.XMLHttpRequest}catch(v){}}function ba(){try{return new a.XMLHttpRequest}catch(g){}}function V(g){return f.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var j=[],n=j.slice,r=j.concat,z=j.push,F=j.indexOf,P={},bd=P.toString,za=P.hasOwnProperty,Ob="".trim,w={},f=function(g,a){return new f.fn.init(g,a)},cd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,dd=/^-ms-/,ed=/-([\da-z])/gi,fd=function(g,a){return a.toUpperCase()};f.fn=f.prototype={jquery:"1.11.0",constructor:f,selector:"",length:0,
...
f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){P["[object "+a+"]"]=a.toLowerCase()});var Pb=a,D=function(g,a,p,b){var f,c,j,d,n;(a?a.ownerDocument||a:W)!==R&&oa(a);a=a||R;p=p||[];if(!g||"string"!==typeof g)return p;if(1!==(d=a.nodeType)&&9!==d)return[];if(X&&!b){if(f=gd.exec(g))if(j=f[1])if(9===d)if((c=a.getElementById(j))&&c.parentNode){if(c.id===j)return p.push(c),p}else return p;else{if(a.ownerDocument&&(c=a.ownerDocument.getElementById(j))&&sa(a,
c)&&c.id===j)return p.push(c),p}else{if(f[2])return Ga.apply(p,a.getElementsByTagName(g)),p;if((j=f[3])&&H.getElementsByClassName&&a.getElementsByClassName)return Ga.apply(p,a.getElementsByClassName(j)),p}if(H.qsa&&(!S||!S.test(g))){c=f=M;j=a;n=9===d&&g;if(1===d&&"object"!==a.nodeName.toLowerCase()){d=ta(g);(f=a.getAttribute("id"))?c=f.replace(hd,"\\$&"):a.setAttribute("id",c);c="[id='"+c+"'] ";for(j=d.length;j--;)d[j]=c+vb(d[j]);j=Qb.test(g)&&ha(a.parentNode)||a;n=d.join(",")}if(n)try{return Ga.apply(p,
j.querySelectorAll(n)),p}catch(e){}finally{f||a.removeAttribute("id")}}}var r;a:{g=g.replace(wb,"$1");c=ta(g);if(!b&&1===c.length){f=c[0]=c[0].slice(0);if(2<f.length&&"ID"===(r=f[0]).type&&H.getById&&9===a.nodeType&&X&&G.relative[f[1].type]){a=(G.find.ID(r.matches[0].replace(Ha,Ia),a)||[])[0];if(!a){r=p;break a}g=g.slice(f.shift().value.length)}for(d=xb.needsContext.test(g)?0:f.length;d--;){r=f[d];if(G.relative[j=r.type])break;if(j=G.find[j])if(b=j(r.matches[0].replace(Ha,Ia),Qb.test(f[0].type)&&
...
c[j]])p[f]=!(b[f]=p[f])})})},ha=function(g){return g&&typeof g.getElementsByTagName!==T&&g},qc=function(){},ta=function(g,a){var p,b,f,c,j,d,n;if(j=Ja[g+" "])return a?0:j.slice(0);j=g;d=[];for(n=G.preFilter;j;){if(!p||(b=kd.exec(j)))b&&(j=j.slice(b[0].length)||j),d.push(f=[]);p=!1;if(b=ld.exec(j))p=b.shift(),f.push({value:p,type:b[0].replace(wb," ")}),j=j.slice(p.length);for(c in G.filter)if((b=xb[c].exec(j))&&(!n[c]||(b=n[c](b))))p=b.shift(),f.push({value:p,type:c,matches:b}),j=j.slice(p.length);
if(!p)break}return a?j.length:j?D.error(g):Ja(g,d).slice(0)},vb=function(g){for(var a=0,p=g.length,b="";a<p;a++)b+=g[a].value;return b},Tb=function(g,a,p){var b=a.dir,f=p&&"parentNode"===b,c=md++;return a.first?function(a,p,v){for(;a=a[b];)if(1===a.nodeType||f)return g(a,p,v)}:function(a,p,v){var j,d,n=[ca,c];if(v)for(;a=a[b];){if((1===a.nodeType||f)&&g(a,p,v))return!0}else for(;a=a[b];)if(1===a.nodeType||f){d=a[M]||(a[M]={});if((j=d[b])&&j[0]===ca&&j[1]===c)return n[2]=j[2];d[b]=n;if(n[2]=g(a,p,
v))return!0}}},Ub=function(g){return 1<g.length?function(a,p,b){for(var f=g.length;f--;)if(!g[f](a,p,b))return!1;return!0}:g[0]},Ta=function(g,a,p,b,f){for(var c,j=[],d=0,n=g.length,e=null!=a;d<n;d++)if(c=g[d])if(!p||p(c,b,f))j.push(c),e&&a.push(d);return j},Vb=function(g,a,p,b,f,c){b&&!b[M]&&(b=Vb(b));f&&!f[M]&&(f=Vb(f,c));return pa(function(c,j,d,n){var e,r,fa=[],q=[],l=j.length,h;if(!(h=c)){h=a||"*";for(var k=d.nodeType?[d]:d,A=[],z=0,T=k.length;z<T;z++)D(h,k[z],A);h=A}h=g&&(c||!a)?Ta(h,fa,g,d,
n):h;k=p?f||(c?g:l||b)?[]:j:h;p&&p(h,k,d,n);if(b){e=Ta(k,q);b(e,[],d,n);for(d=e.length;d--;)if(r=e[d])k[q[d]]=!(h[q[d]]=r)}if(c){if(f||g){if(f){e=[];for(d=k.length;d--;)if(r=k[d])e.push(h[d]=r);f(null,k=[],e,n)}for(d=k.length;d--;)if((r=k[d])&&-1<(e=f?Ua.call(c,r):fa[d]))c[e]=!(j[e]=r)}}else k=Ta(k===j?k.splice(l,k.length):k),f?f(null,j,k,n):Ga.apply(j,k)})},Wb=function(g){var a,p,b,f=g.length,c=G.relative[g[0].type];p=c||G.relative[" "];for(var j=c?1:0,d=Tb(function(g){return g===a},p,!0),n=Tb(function(g){return-1<
Ua.call(a,g)},p,!0),e=[function(g,p,b){return!c&&(b||p!==Aa)||((a=p).nodeType?d(g,p,b):n(g,p,b))}];j<f;j++)if(p=G.relative[g[j].type])e=[Tb(Ub(e),p)];else{p=G.filter[g[j].type].apply(null,g[j].matches);if(p[M]){for(b=++j;b<f&&!G.relative[g[b].type];b++);return Vb(1<j&&Ub(e),1<j&&vb(g.slice(0,j-1).concat({value:" "===g[j-2].type?"*":""})).replace(wb,"$1"),p,j<b&&Wb(g.slice(j,b)),b<f&&Wb(g=g.slice(b)),b<f&&vb(g))}e.push(p)}return Ub(e)},Ba,H,G,Ka,rc,$a,Aa,ra,Ca,oa,R,ja,X,S,da,La,sa,M="sizzle"+-new Date,
...
function(a,b,p){var v,e,r,h,k;b=j!==d?"nextSibling":"previousSibling";var q=a.parentNode,l=n&&a.nodeName.toLowerCase();p=!p&&!n;if(q){if(j){for(;b;){for(e=a;e=e[b];)if(n?e.nodeName.toLowerCase()===l:1===e.nodeType)return!1;k=b="only"===g&&!k&&"nextSibling"}return!0}k=[d?q.firstChild:q.lastChild];if(d&&p){p=q[M]||(q[M]={});v=p[g]||[];h=v[0]===ca&&v[1];r=v[0]===ca&&v[2];for(e=h&&q.childNodes[h];e=++h&&e&&e[b]||(r=h=0)||k.pop();)if(1===e.nodeType&&++r&&e===a){p[g]=[ca,h,r];break}}else if(p&&(v=(a[M]||
(a[M]={}))[g])&&v[0]===ca)r=v[1];else for(;e=++h&&e&&e[b]||(r=h=0)||k.pop();)if((n?e.nodeName.toLowerCase()===l:1===e.nodeType)&&++r)if(p&&((e[M]||(e[M]={}))[g]=[ca,r]),e===a)break;r-=c;return r===f||0===r%f&&0<=r/f}}},PSEUDO:function(g,a){var b,f=G.pseudos[g]||G.setFilters[g.toLowerCase()]||D.error("unsupported pseudo: "+g);return f[M]?f(a):1<f.length?(b=[g,g,"",a],G.setFilters.hasOwnProperty(g.toLowerCase())?pa(function(g,b){for(var p,c=f(g,a),j=c.length;j--;)p=Ua.call(g,c[j]),g[p]=!(b[p]=c[j])}):
function(g){return f(g,0,b)}):f}},pseudos:{not:pa(function(g){var a=[],b=[],f=$a(g.replace(wb,"$1"));return f[M]?pa(function(g,a,b,p){p=f(g,null,p,[]);for(var v=g.length;v--;)if(b=p[v])g[v]=!(a[v]=b)}):function(g,c,j){a[0]=g;f(a,null,j,b);return!b.pop()}}),has:pa(function(g){return function(a){return 0<D(g,a).length}}),contains:pa(function(g){return function(a){return-1<(a.textContent||a.innerText||Ka(a)).indexOf(g)}}),lang:pa(function(g){qd.test(g||"")||D.error("unsupported lang: "+g);g=g.replace(Ha,
...
a,b){for(b=0>b?b+a:b;++b<a;)g.push(b);return g})}};G.pseudos.nth=G.pseudos.eq;for(Ba in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})G.pseudos[Ba]=id(Ba);for(Ba in{submit:!0,reset:!0})G.pseudos[Ba]=jd(Ba);qc.prototype=G.filters=G.pseudos;G.setFilters=new qc;$a=D.compile=function(g,a){var b,f=[],c=[],j=Da[g+" "];if(!j){a||(a=ta(g));for(b=a.length;b--;)j=Wb(a[b]),j[M]?f.push(j):c.push(j);var d=0<f.length,n=0<c.length;b=function(g,a,b,p,v){var j,e,r,h=0,fa="0",k=g&&[],q=[],l=Aa,A=g||n&&G.find.TAG("*",
v),z=ca+=null==l?1:Math.random()||0.1,T=A.length;for(v&&(Aa=a!==R&&a);fa!==T&&null!=(j=A[fa]);fa++){if(n&&j){for(e=0;r=c[e++];)if(r(j,a,b)){p.push(j);break}v&&(ca=z)}d&&((j=!r&&j)&&h--,g&&k.push(j))}h+=fa;if(d&&fa!==h){for(e=0;r=f[e++];)r(k,q,a,b);if(g){if(0<h)for(;fa--;)!k[fa]&&!q[fa]&&(q[fa]=Y.call(p));q=Ta(q)}Ga.apply(p,q);v&&(!g&&0<q.length&&1<h+f.length)&&D.uniqueSort(p)}v&&(ca=z,Aa=l);return k};b=d?pa(b):b;j=Da(g,b)}return j};H.sortStable=M.split("").sort(A).join("")===M;H.detectDuplicates=
...
c){var j=f.map(this,a,b);"Until"!==g.slice(-5)&&(c=b);c&&"string"===typeof c&&(j=f.filter(c,j));1<this.length&&(vd[g]||(j=f.unique(j)),ud.test(g)&&(j=j.reverse()));return this.pushStack(j)}});var xa=/\S+/g,yc={};f.Callbacks=function(g){var a;if("string"===typeof g){if(!(a=yc[g])){a=g;var b=yc[a]={};f.each(a.match(xa)||[],function(g,a){b[a]=!0});a=b}}else a=f.extend({},g);g=a;var c,j,d,n,e,r,h=[],k=!g.once&&[],q=function(a){j=g.memory&&a;d=!0;e=r||0;r=0;n=h.length;for(c=!0;h&&e<n;e++)if(!1===h[e].apply(a[0],
a[1])&&g.stopOnFalse){j=!1;break}c=!1;h&&(k?k.length&&q(k.shift()):j?h=[]:l.disable())},l={add:function(){if(h){var a=h.length;(function $c(a){f.each(a,function(a,b){var c=f.type(b);"function"===c?(!g.unique||!l.has(b))&&h.push(b):b&&(b.length&&"string"!==c)&&$c(b)})})(arguments);c?n=h.length:j&&(r=a,q(j))}return this},remove:function(){h&&f.each(arguments,function(g,a){for(var b;-1<(b=f.inArray(a,h,b));)h.splice(b,1),c&&(b<=n&&n--,b<=e&&e--)});return this},has:function(g){return g?-1<f.inArray(g,
...
b?f.queue(this[0],g):void 0===a?this:this.each(function(){var b=f.queue(this,g,a);f._queueHooks(this,g);"fx"===g&&"inprogress"!==b[0]&&f.dequeue(this,g)})},dequeue:function(a){return this.each(function(){f.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,j=1,d=f.Deferred(),n=this,e=this.length,r=function(){--j||d.resolveWith(n,[n])};"string"!==typeof a&&(b=a,a=void 0);for(a=a||"fx";e--;)if((c=f._data(n[e],a+"queueHooks"))&&c.empty)j++,c.empty.add(r);
...
nb=null,Ab,Bb,Ac=y.createElement("div");for(Ab in{submit:!0,change:!0,focusin:!0})if(Bb="on"+Ab,!(w[Ab+"Bubbles"]=Bb in a))Ac.setAttribute(Bb,"t"),w[Ab+"Bubbles"]=!1===Ac.attributes[Bb].expando;var Zb=/^(?:input|select|textarea)$/i,xd=/^key/,yd=/^(?:mouse|contextmenu)|click/,Bc=/^(?:focusinfocus|focusoutblur)$/,Cc=/^([^.]*)(?:\.(.+)|)$/;f.event={global:{},add:function(a,b,c,j,d){var n,e,r,h,k,q,l,A,z;if(r=f._data(a)){c.handler&&(h=c,c=h.handler,d=h.selector);c.guid||(c.guid=f.guid++);if(!(e=r.events))e=
r.events={};if(!(k=r.handle))k=r.handle=function(a){return typeof f!==la&&(!a||f.event.triggered!==a.type)?f.event.dispatch.apply(k.elem,arguments):void 0},k.elem=a;b=(b||"").match(xa)||[""];for(r=b.length;r--;)if(n=Cc.exec(b[r])||[],A=q=n[1],z=(n[2]||"").split(".").sort(),A){n=f.event.special[A]||{};A=(d?n.delegateType:n.bindType)||A;n=f.event.special[A]||{};q=f.extend({type:A,origType:q,data:j,handler:c,guid:c.guid,selector:d,needsContext:d&&f.expr.match.needsContext.test(d),namespace:z.join(".")},
h);if(!(l=e[A]))if(l=e[A]=[],l.delegateCount=0,!n.setup||!1===n.setup.call(a,j,z,k))a.addEventListener?a.addEventListener(A,k,!1):a.attachEvent&&a.attachEvent("on"+A,k);n.add&&(n.add.call(a,q),q.handler.guid||(q.handler.guid=c.guid));d?l.splice(l.delegateCount++,0,q):l.push(q);f.event.global[A]=!0}a=null}},remove:function(a,b,c,j,d){var n,e,r,h,k,q,l,A,z,T,s,m=f.hasData(a)&&f._data(a);if(m&&(q=m.events)){b=(b||"").match(xa)||[""];for(k=b.length;k--;)if(r=Cc.exec(b[k])||[],z=s=r[1],T=(r[2]||"").split(".").sort(),
z){l=f.event.special[z]||{};z=(j?l.delegateType:l.bindType)||z;A=q[z]||[];r=r[2]&&RegExp("(^|\\.)"+T.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=n=A.length;n--;)if(e=A[n],(d||s===e.origType)&&(!c||c.guid===e.guid)&&(!r||r.test(e.namespace))&&(!j||j===e.selector||"**"===j&&e.selector))A.splice(n,1),e.selector&&A.delegateCount--,l.remove&&l.remove.call(a,e);h&&!A.length&&((!l.teardown||!1===l.teardown.call(a,T,m.handle))&&f.removeEvent(a,z,m.handle),delete q[z])}else for(z in q)f.event.remove(a,z+b[k],c,
j,!0);f.isEmptyObject(q)&&(delete m.handle,f._removeData(a,"events"))}},trigger:function(g,b,c,j){var d,n,e,r,h,k,q=[c||y],l=za.call(g,"type")?g.type:g;h=za.call(g,"namespace")?g.namespace.split("."):[];e=d=c=c||y;if(!(3===c.nodeType||8===c.nodeType)&&!Bc.test(l+f.event.triggered))if(0<=l.indexOf(".")&&(h=l.split("."),l=h.shift(),h.sort()),n=0>l.indexOf(":")&&"on"+l,g=g[f.expando]?g:new f.Event(l,"object"===typeof g&&g),g.isTrigger=j?2:3,g.namespace=h.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+
h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=void 0,g.target||(g.target=c),b=null==b?[g]:f.makeArray(b,[g]),h=f.event.special[l]||{},j||!(h.trigger&&!1===h.trigger.apply(c,b))){if(!j&&!h.noBubble&&!f.isWindow(c)){r=h.delegateType||l;Bc.test(r+l)||(e=e.parentNode);for(;e;e=e.parentNode)q.push(e),d=e;if(d===(c.ownerDocument||y))q.push(d.defaultView||d.parentWindow||a)}for(k=0;(e=q[k++])&&!g.isPropagationStopped();)if(g.type=1<k?r:h.bindType||l,(d=(f._data(e,"events")||{})[g.type]&&f._data(e,"handle"))&&
d.apply(e,b),(d=n&&e[n])&&d.apply&&f.acceptData(e))g.result=d.apply(e,b),!1===g.result&&g.preventDefault();g.type=l;if(!j&&!g.isDefaultPrevented()&&(!h._default||!1===h._default.apply(q.pop(),b))&&f.acceptData(c)&&n&&c[l]&&!f.isWindow(c)){(d=c[n])&&(c[n]=null);f.event.triggered=l;try{c[l]()}catch(A){}f.event.triggered=void 0;d&&(c[n]=d)}return g.result}},dispatch:function(a){a=f.event.fix(a);var b,c,j,d,e=[],r=n.call(arguments);b=(f._data(this,"events")||{})[a.type]||[];var h=f.event.special[a.type]||
...
a);return a.result}},handlers:function(a,b){var c,j,d,n,e=[],r=b.delegateCount,h=a.target;if(r&&h.nodeType&&(!a.button||"click"!==a.type))for(;h!=this;h=h.parentNode||this)if(1===h.nodeType&&(!0!==h.disabled||"click"!==a.type)){d=[];for(n=0;n<r;n++)j=b[n],c=j.selector+" ",void 0===d[c]&&(d[c]=j.needsContext?0<=f(c,this).index(h):f.find(c,this,null,[h]).length),d[c]&&d.push(j);d.length&&e.push({elem:h,handlers:d})}r<b.length&&e.push({elem:this,handlers:b.slice(r)});return e},fix:function(a){if(a[f.expando])return a;
...
f&&f.clientLeft||0),a.pageY=b.clientY+(c&&c.scrollTop||f&&f.scrollTop||0)-(c&&c.clientTop||f&&f.clientTop||0));!a.relatedTarget&&d&&(a.relatedTarget=d===a.target?b.toElement:d);!a.which&&void 0!==j&&(a.which=j&1?1:j&2?3:j&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==I()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){if(this===I()&&this.blur)return this.blur(),!1},delegateType:"focusout"},click:{trigger:function(){if(f.nodeName(this,
...
B(y).appendChild(y.createElement("div"));ka.optgroup=ka.option;ka.tbody=ka.tfoot=ka.colgroup=ka.caption=ka.thead;ka.th=ka.td;f.extend({clone:function(a,b,c){var j,d,n,e,r,h=f.contains(a.ownerDocument,a);w.html5Clone||f.isXMLDoc(a)||!Dc.test("<"+a.nodeName+">")?n=a.cloneNode(!0):(ac.innerHTML=a.outerHTML,ac.removeChild(n=ac.firstChild));if((!w.noCloneEvent||!w.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!f.isXMLDoc(a)){j=E(n);r=E(a);for(e=0;null!=(d=r[e]);++e)if(j[e]){var k=j[e],l=void 0,q=
void 0,A=void 0;if(1===k.nodeType){l=k.nodeName.toLowerCase();if(!w.noCloneEvent&&k[f.expando]){A=f._data(k);for(q in A.events)f.removeEvent(k,q,A.handle);k.removeAttribute(f.expando)}if("script"===l&&k.text!==d.text)Ea(k).text=d.text,U(k);else if("object"===l)k.parentNode&&(k.outerHTML=d.outerHTML),w.html5Clone&&(d.innerHTML&&!f.trim(k.innerHTML))&&(k.innerHTML=d.innerHTML);else if("input"===l&&Mb.test(d.type))k.defaultChecked=k.checked=d.checked,k.value!==d.value&&(k.value=d.value);else if("option"===
l)k.defaultSelected=k.selected=d.defaultSelected;else if("input"===l||"textarea"===l)k.defaultValue=d.defaultValue}}}if(b)if(c){r=r||E(a);j=j||E(n);for(e=0;null!=(d=r[e]);e++)Fa(d,j[e])}else Fa(a,n);j=E(n,"script");0<j.length&&Q(j,!h&&E(a,"script"));return n},buildFragment:function(a,b,c,j){for(var d,n,e,r,h,k,l=a.length,q=B(b),A=[],z=0;z<l;z++)if((n=a[z])||0===n)if("object"===f.type(n))f.merge(A,n.nodeType?[n]:n);else if(Ad.test(n)){e=e||q.appendChild(b.createElement("div"));r=(Fc.exec(n)||["",""])[1].toLowerCase();
...
j));return void 0===d?d:d+""}):y.documentElement.currentStyle&&(Ra=function(a){return a.currentStyle},Sa=function(a,b,c){var f,j,d,n=a.style;d=(c=c||Ra(a))?c[b]:void 0;null==d&&(n&&n[b])&&(d=n[b]);if(sb.test(d)&&!Ed.test(b)){c=n.left;if(j=(f=a.runtimeStyle)&&f.left)f.left=a.currentStyle.left;n.left="fontSize"===b?"1em":d;d=n.pixelLeft+"px";n.left=c;j&&(f.left=j)}return void 0===d?d:d+""||"auto"});var dc=function(){var g,b,c=y.getElementsByTagName("body")[0];c&&(g=y.createElement("div"),b=y.createElement("div"),
...
!1,j))?d:h[b]}},css:function(a,b,c,j){var d,n;n=f.camelCase(b);b=f.cssProps[n]||(f.cssProps[n]=gb(a.style,n));(n=f.cssHooks[b]||f.cssHooks[n])&&"get"in n&&(d=n.get(a,!0,c));void 0===d&&(d=Sa(a,b,j));"normal"===d&&b in Jc&&(d=Jc[b]);return""===c||c?(a=parseFloat(d),!0===c||f.isNumeric(a)?a||0:d):d}});f.each(["height","width"],function(a,b){f.cssHooks[b]={get:function(a,g,c){if(g)return 0===a.offsetWidth&&Gd.test(f.css(a,"display"))?f.swap(a,Id,function(){return aa(a,b,c)}):aa(a,b,c)},set:function(a,
g,c){var j=c&&Ra(a);return ma(a,g,c?x(a,b,c,w.boxSizing()&&"border-box"===f.css(a,"boxSizing",!1,j),j):0)}}});w.opacity||(f.cssHooks.opacity={get:function(a,b){return Fd.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,j=a.currentStyle,d=f.isNumeric(b)?"alpha(opacity="+100*b+")":"",n=j&&j.filter||c.filter||"";c.zoom=1;if((1<=b||""===b)&&""===f.trim(n.replace(ec,""))&&c.removeAttribute)if(c.removeAttribute("filter"),
""===b||j&&!j.filter)return;c.filter=ec.test(n)?n.replace(ec,d):n+" "+d}});f.cssHooks.marginRight=fb(w.reliableMarginRight,function(a,b){if(b)return f.swap(a,{display:"inline-block"},Sa,[a,"marginRight"])});f.each({margin:"",padding:"",border:"Width"},function(a,b){f.cssHooks[a+b]={expand:function(c){var f=0,j={};for(c="string"===typeof c?c.split(" "):[c];4>f;f++)j[a+Qa[f]+b]=c[f]||c[f-2]||c[0];return j}};Ic.test(a)||(f.cssHooks[a+b].set=ma)});f.fn.extend({css:function(a,b){return Va(this,function(a,
g,b){var c,j={},d=0;if(f.isArray(g)){b=Ra(a);for(c=g.length;d<c;d++)j[g[d]]=f.css(a,g[d],!1,b);return j}return void 0!==b?f.style(a,g,b):f.css(a,g)},a,b,1<arguments.length)},show:function(){return va(this,!0)},hide:function(){return va(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){hb(this)?f(this).show():f(this).hide()})}});f.Tween=L;L.prototype={constructor:L,init:function(a,b,c,j,d,n){this.elem=a;this.prop=c;this.easing=d||"swing";this.options=
b;this.start=this.now=this.cur();this.end=j;this.unit=n||(f.cssNumber[c]?"":"px")},cur:function(){var a=L.propHooks[this.prop];return a&&a.get?a.get(this):L.propHooks._default.get(this)},run:function(a){var b,c=L.propHooks[this.prop];this.pos=this.options.duration?b=f.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);c&&c.set?c.set(this):L.propHooks._default.set(this);
...
!0;f.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=d.length;b--;)d[b].elem===this&&d[b].queue===a&&(d[b].anim.stop(!0),d.splice(b,1));for(b=0;b<n;b++)j[b]&&j[b].finish&&j[b].finish.call(this);delete c.finish})}});f.each(["toggle","show","hide"],function(a,b){var c=f.fn[b];f.fn[b]=function(a,g,j){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(O(b,!0),a,g,j)}});f.each({slideDown:O("show"),slideUp:O("hide"),slideToggle:O("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},
...
Lc={set:function(a,b,c){!1===b?f.removeAttr(a,c):Jb&&Wa||!hc.test(c)?a.setAttribute(!Wa&&f.propFix[c]||c,c):a[f.camelCase("default-"+c)]=a[c]=!0;return c}};f.each(f.expr.match.bool.source.match(/\w+/g),function(a,b){var c=Na[b]||f.find.attr;Na[b]=Jb&&Wa||!hc.test(b)?function(a,b,g){var j,f;g||(f=Na[b],Na[b]=j,j=null!=c(a,b,g)?b.toLowerCase():null,Na[b]=f);return j}:function(a,b,g){if(!g)return a[f.camelCase("default-"+b)]?b.toLowerCase():null}});if(!Jb||!Wa)f.attrHooks.value={set:function(a,b,c){if(f.nodeName(a,
...
c,j,d,n,e=0,r=this.length;b="string"===typeof a&&a;if(f.isFunction(a))return this.each(function(b){f(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(xa)||[];e<r;e++)if(c=this[e],j=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ic," "):" ")){for(n=0;d=b[n++];)0>j.indexOf(" "+d+" ")&&(j+=d+" ");j=f.trim(j);c.className!==j&&(c.className=j)}return this},removeClass:function(a){var b,c,j,d,n,e=0,r=this.length;b=0===arguments.length||"string"===typeof a&&a;if(f.isFunction(a))return this.each(function(b){f(this).removeClass(a.call(this,
b,this.className))});if(b)for(b=(a||"").match(xa)||[];e<r;e++)if(c=this[e],j=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ic," "):"")){for(n=0;d=b[n++];)for(;0<=j.indexOf(" "+d+" ");)j=j.replace(" "+d+" "," ");j=a?f.trim(j):"";c.className!==j&&(c.className=j)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"===typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):f.isFunction(a)?this.each(function(c){f(this).toggleClass(a.call(this,c,this.className,b),b)}):
this.each(function(){if("string"===c)for(var b,j=0,d=f(this),n=a.match(xa)||[];b=n[j++];)d.hasClass(b)?d.removeClass(b):d.addClass(b);else if(c===la||"boolean"===c)this.className&&f._data(this,"__className__",this.className),this.className=this.className||!1===a?"":f._data(this,"__className__")||""})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if(1===this[b].nodeType&&0<=(" "+this[b].className+" ").replace(ic," ").indexOf(a))return!0;return!1}});f.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),
...
f.ajaxSettings),b):ya(f.ajaxSettings,a)},ajaxPrefilter:kb(Oc),ajaxTransport:kb(Nb),ajax:function(a,b){function c(a,b,g,j){var d,l,p,I;I=b;if(2!==ea){ea=2;r&&clearTimeout(r);k=void 0;e=j||"";t.readyState=0<a?4:0;j=200<=a&&300>a||304===a;if(g){p=q;for(var v=t,N,ia,F,B,E=p.contents,P=p.dataTypes;"*"===P[0];)P.shift(),void 0===ia&&(ia=p.mimeType||v.getResponseHeader("Content-Type"));if(ia)for(B in E)if(E[B]&&E[B].test(ia)){P.unshift(B);break}if(P[0]in g)F=P[0];else{for(B in g){if(!P[0]||p.converters[B+
" "+P[0]]){F=B;break}N||(N=B)}F=F||N}F?(F!==P[0]&&P.unshift(F),p=g[F]):p=void 0}a:{g=q;N=p;ia=t;F=j;var w,Y,u,v={},E=g.dataTypes.slice();if(E[1])for(Y in g.converters)v[Y.toLowerCase()]=g.converters[Y];for(B=E.shift();B;)if(g.responseFields[B]&&(ia[g.responseFields[B]]=N),!u&&(F&&g.dataFilter)&&(N=g.dataFilter(N,g.dataType)),u=B,B=E.shift())if("*"===B)B=u;else if("*"!==u&&u!==B){Y=v[u+" "+B]||v["* "+B];if(!Y)for(w in v)if(p=w.split(" "),p[1]===B&&(Y=v[u+" "+p[0]]||v["* "+p[0]])){!0===Y?Y=v[w]:!0!==
v[w]&&(B=p[0],E.unshift(p[1]));break}if(!0!==Y)if(Y&&g["throws"])N=Y(N);else try{N=Y(N)}catch(K){p={state:"parsererror",error:Y?K:"No conversion from "+u+" to "+B};break a}}p={state:"success",data:N}}if(j)q.ifModified&&((I=t.getResponseHeader("Last-Modified"))&&(f.lastModified[n]=I),(I=t.getResponseHeader("etag"))&&(f.etag[n]=I)),204===a||"HEAD"===q.type?I="nocontent":304===a?I="notmodified":(I=p.state,d=p.data,l=p.error,j=!l);else if(l=I,a||!I)I="error",0>a&&(a=0);t.status=a;t.statusText=(b||I)+
"";j?T.resolveWith(A,[d,I,t]):T.rejectWith(A,[t,I,l]);t.statusCode(m);m=void 0;h&&z.trigger(j?"ajaxSuccess":"ajaxError",[t,q,j?d:l]);s.fireWith(A,[t,I]);h&&(z.trigger("ajaxComplete",[t,q]),--f.active||f.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var j,d,n,e,r,h,k,l,q=f.ajaxSetup({},b),A=q.context||q,z=q.context&&(A.nodeType||A.jquery)?f(A):f.event,T=f.Deferred(),s=f.Callbacks("once memory"),m=q.statusCode||{},I={},N={},ea=0,ia="canceled",t={readyState:0,getResponseHeader:function(a){var b;
if(2===ea){if(!l)for(l={};b=Qd.exec(e);)l[b[1].toLowerCase()]=b[2];b=l[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===ea?e:null},setRequestHeader:function(a,b){var c=a.toLowerCase();ea||(a=N[c]=N[c]||a,I[a]=b);return this},overrideMimeType:function(a){ea||(q.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>ea)for(b in a)m[b]=[m[b],a[b]];else t.always(a[t.status]);return this},abort:function(a){a=a||ia;k&&k.abort(a);c(0,a);return this}};T.promise(t).complete=
s.add;t.success=t.done;t.error=t.fail;q.url=((a||q.url||Oa)+"").replace(Pd,"").replace(Sd,Xa[1]+"//");q.type=b.method||b.type||q.method||q.type;q.dataTypes=f.trim(q.dataType||"*").toLowerCase().match(xa)||[""];null==q.crossDomain&&(j=Nc.exec(q.url.toLowerCase()),q.crossDomain=!(!j||!(j[1]!==Xa[1]||j[2]!==Xa[2]||(j[3]||("http:"===j[1]?"80":"443"))!==(Xa[3]||("http:"===Xa[1]?"80":"443")))));q.data&&(q.processData&&"string"!==typeof q.data)&&(q.data=f.param(q.data,q.traditional));ub(Oc,q,b,t);if(2===
ea)return t;(h=q.global)&&0===f.active++&&f.event.trigger("ajaxStart");q.type=q.type.toUpperCase();q.hasContent=!Rd.test(q.type);n=q.url;q.hasContent||(q.data&&(n=q.url+=(kc.test(n)?"&":"?")+q.data,delete q.data),!1===q.cache&&(q.url=Mc.test(n)?n.replace(Mc,"$1_="+jc++):n+(kc.test(n)?"&":"?")+"_="+jc++));q.ifModified&&(f.lastModified[n]&&t.setRequestHeader("If-Modified-Since",f.lastModified[n]),f.etag[n]&&t.setRequestHeader("If-None-Match",f.etag[n]));(q.data&&q.hasContent&&!1!==q.contentType||b.contentType)&&
t.setRequestHeader("Content-Type",q.contentType);t.setRequestHeader("Accept",q.dataTypes[0]&&q.accepts[q.dataTypes[0]]?q.accepts[q.dataTypes[0]]+("*"!==q.dataTypes[0]?", "+Pc+"; q=0.01":""):q.accepts["*"]);for(d in q.headers)t.setRequestHeader(d,q.headers[d]);if(q.beforeSend&&(!1===q.beforeSend.call(A,t,q)||2===ea))return t.abort();ia="abort";for(d in{success:1,error:1,complete:1})t[d](q[d]);if(k=ub(Nb,q,b,t)){t.readyState=1;h&&z.trigger("ajaxSend",[t,q]);q.async&&0<q.timeout&&(r=setTimeout(function(){t.abort("timeout")},
q.timeout));try{ea=1,k.send(I,c)}catch(F){if(2>ea)c(-1,F);else throw F;}}else c(-1,"No Transport");return t},getJSON:function(a,b,c){return f.get(a,b,c,"json")},getScript:function(a,b){return f.get(a,void 0,b,"script")}});f.each(["get","post"],function(a,b){f[b]=function(a,c,g,j){f.isFunction(c)&&(j=j||g,g=c,c=void 0);return f.ajax({url:a,type:b,dataType:j,data:c,success:g})}});f.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){f.fn[b]=function(a){return this.on(b,
...
C()||C(1)};var Wd=0,Kb={},Lb=f.ajaxSettings.xhr();if(a.ActiveXObject)f(a).on("unload",function(){for(var a in Kb)Kb[a](void 0,!0)});w.cors=!!Lb&&"withCredentials"in Lb;(Lb=w.ajax=!!Lb)&&f.ajaxTransport(function(a){if(!a.crossDomain||w.cors){var b;return{send:function(c,j){var d,n=a.xhr(),e=++Wd;console.log("xhr.open async="+a.async+" url="+a.url);n.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(d in a.xhrFields)n[d]=a.xhrFields[d];a.mimeType&&n.overrideMimeType&&n.overrideMimeType(a.mimeType);
...
b.left-n.left+j);"using"in b?b.using.call(a,q):r.css(q)}};f.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){f.offset.setOffset(this,a,b)});var b,c,j={top:0,left:0},d=(c=this[0])&&c.ownerDocument;if(d){b=d.documentElement;if(!f.contains(b,c))return j;typeof c.getBoundingClientRect!==la&&(j=c.getBoundingClientRect());c=V(d);return{top:j.top+(c.pageYOffset||b.scrollTop)-(b.clientTop||0),left:j.left+(c.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}}},position:function(){if(this[0]){var a,
...
b)};a._playAudio=function(a,c){var d=c.get?function(a){return c.get(a)}:null,e=c.put?function(a,b){return c.put(a,b)}:null,h=d?d("audioFile"):c,k=d&&d("audioPlayer"),l=document.createElement("audio");e&&e("audioElement",l);var s=null;k&&(s=function(a){k.processUpdate(a)},k.myClip={open:function(){s("open")},start:function(){l.play();s("start")},loop:function(a){l.loop=0!=a},stop:function(){l.pause()},close:function(){s("close")},setMicrosecondPosition:function(a){l.currentTime=a/1E6}});l.controls=
...
t)u=a._getRawDataFromServer("_",b,c,c,h,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var Q={dataType:e?"binary":"text",async:!!c};k?(Q.type="POST",Q.url=b.split("?POST?")[0],Q.data=b.split("?POST?")[1]):(Q.type="GET",Q.url=b);c&&(Q.success=function(){c(a._xhrReturn(Q.xhr))},Q.error=function(){c(Q.xhr.statusText)});Q.xhr=a.$ajax(Q);c||(u=a._xhrReturn(Q.xhr))}if(!d)return u;null==u&&(u="",e=!1);e&&(e=a._canSyncBinary(!0));return e?a._strToBytes(u):JU.SB.newS(u)};a._xhrReturn=function(a){return!a.responseText||
...
c))return"OK";b=b.substring(b.lastIndexOf("/")+1);d||(d=0<=b.indexOf(".pdf")?"application/pdf":0<=b.indexOf(".png")?"image/png":0<=b.indexOf(".gif")?"image/gif":0<=b.indexOf(".jpg")?"image/jpg":"");c=(JU||J.util).Base64.getBase64("string"==typeof c?c.getBytes("UTF-8"):c).toString();e||(e="base64");var h=a._serverUrl;h&&0<=h.indexOf("your.server")&&(h="");a._useDataURI||!h?(e=document.createElement("a"),e.href="data:"+d+";base64,"+c,e.type=d||"text/plain;charset=utf-8",e.download=b,e.target="_blank",
m("body").append(e),e.click(),e.remove()):(a._formdiv||(a.$after("body",'<div id="__jsmolformdiv__" style="display:none">\t\t\t\t\t\t<form id="__jsmolform__" method="post" target="_blank" action="">\t\t\t\t\t\t<input name="call" value="saveFile"/>\t\t\t\t\t\t<input id="__jsmolmimetype__" name="mimetype" value=""/>\t\t\t\t\t\t<input id="__jsmolencoding__" name="encoding" value=""/>\t\t\t\t\t\t<input id="__jsmolfilename__" name="filename" value=""/>\t\t\t\t\t\t<textarea id="__jsmoldata__" name="data"></textarea>\t\t\t\t\t\t</form>\t\t\t\t\t\t</div>'),
...
b._processGesture=function(a){return this._appletPanel.processTwoPointGesture(a)};b._processEvent=function(a,b){this._appletPanel.processMouseEvent(a,b[0],b[1],b[2],System.currentTimeMillis())};b._resize=function(){var b="__resizeTimeout_"+this._id;a[b]&&clearTimeout(a[b]);var c=this;a[b]=setTimeout(function(){a._repaint(c,!0);a[b]=null},100)};return b};a._repaint=function(b,d){if(b&&b._appletPanel){var e=a.$(b,"appletdiv"),h=Math.round(e.width()),e=Math.round(e.height());if(b._is2D&&(b._canvas.width!=
h||b._canvas.height!=e))b._newCanvas(!0),b._appletPanel.setDisplay(b._canvas);b._appletPanel.setScreenDimension(h,e);h=function(){b._appletPanel.paint?b._appletPanel.paint(null):b._appletPanel.update(null)};d?requestAnimationFrame(h):h()}};a._loadImage=function(b,e,h,k,l,s){var m="echo_"+e+h+(k?"_"+k.length:""),t=a._getHiddenCanvas(b.vwr.html5Applet,m,0,0,!1,!0);if(null==t){if(null==s){s=new Image;if(null==k)return s.onload=function(){a._loadImage(b,e,h,null,l,s)},s.src=h,null;System.out.println("Jsmol.js Jmol._loadImage using data URI for "+
m);s.src="string"==typeof k?k:"data:"+JU.Rdr.guessMimeTypeForBytes(k)+";base64,"+JU.Base64.getBase64(k)}var u=s.width,U=s.height;"webgl"==e&&(u/=2,U/=2);t=a._getHiddenCanvas(b.vwr.html5Applet,m,u,U,!0,!1);t.imageWidth=u;t.imageHeight=U;t.id=m;t.image=s;a._setCanvasImage(t,u,U)}else System.out.println("Jsmol.js Jmol._loadImage reading cached image for "+m);return null==k?l(t,h):t};a._canvasCache={};a._getHiddenCanvas=function(b,e,h,k,l,s){e=b._id+"_"+e;b=a._canvasCache[e];if(s)return b;if(l||!b||b.width!=
...
a._hideLocalFileReader(this);this._applet.script(e)};h._syncScript=function(a){this._applet.syncScript(a)};h._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};h._scriptWait=function(a,h){var l=this._scriptWaitAsArray(a),m="";if(!h)for(var u=l.length;0<=--u;)for(var b=0,c=l[u].length;b<c;b++)m+=l[u][b]+"\n";return m};h._scriptEcho=function(a){a=this._scriptWaitAsArray(a);for(var h="",l=a.length;0<=--l;)for(var m=a[l].length;0<=--m;)"scriptEcho"==a[l][m][1]&&(h+=a[l][m][3]+"\n");
...
e<a._allowedJmolSize[0]?a._allowedJmolSize[0]:e>a._allowedJmolSize[1]?a._allowedJmolSize[1]:e)+(l?l:"")}var l;"object"==typeof e&&null!=e?(l=e[0]||e.width,e=e[1]||e.height):l=e;l=[h(l,"px"),h(e,"px")];e=a._getElement(this,"appletinfotablediv");e.style.width=l[0];e.style.height=l[1];this._containerWidth=l[0];this._containerHeight=l[1];this._is2D&&a._repaint(this,!0)};h._search=function(e,h){a._search(this,e,h)};h._searchDatabase=function(e,h,l){if(this._2dapplet&&this._2dapplet._isEmbedded&&!a.$(this,
...
a.jmolButton=function(l,h,e,k,m){return a.controls._getButton(l,h,e,k,m)};a.jmolCheckbox=function(l,h,e,k,m,t,u){return a.controls._getCheckbox(l,h,e,k,m,t,u)};a.jmolCommandInput=function(l,h,e,k,m,t){return a.controls._getCommandInput(l,h,e,k,m,t)};a.jmolHtml=function(l){return a._documentWrite(l)};a.jmolLink=function(l,h,e,k,m){return a.controls._getLink(l,h,e,k,m)};a.jmolMenu=function(l,h,e,k,m){return a.controls._getMenu(l,h,e,k,m)};a.jmolRadio=function(l,h,e,k,m,t,u,b){return a.controls._getRadio(l,
h,e,k,m,t,u,b)};a.jmolRadioGroup=function(l,h,e,k,m,t){return a.controls._getRadioGroup(l,h,e,k,m,t)};a.setCheckboxGroup=function(l,h){a.controls._cbSetCheckboxGroup(l,h,arguments)};a.setDocument=function(l){a._document=l};a.setXHTML=function(l){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;l&&(a._XhtmlElement=document.getElementById(l),a._XhtmlAppendChild=!0)};a.setAppletCss=function(l,h){null!=l&&(a._appletCssClass=l);a._appletCssText=h?h+" ":l?'class="'+l+'" ':""};a.setButtonCss=function(l,
...
[];var b=function(){this.toString=function(){return"J2S MethodException"}},c;try{null.hello()}catch(d){if(k=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var k=d.message.indexOf(":"),q=d.message.indexOf(":",k+2),I=d.message.substr(k+1,q-k-20);c=function(a){return-1!=a.message.indexOf(I)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var B=k(d.message,"hello");
c=function(a){return B.test(a.message)}}else B=k(d.message,"$$o$$"),c=function(a){return B.test(a.message)}}a.exceptionOf=function(b,d){if(b.__CLASS_NAME__)return a.instanceOf(b,d);b.getMessage||(b.getMessage=function(){return""+b+(b.stack?"\n"+b.stack:"")});b.printStackTrace||(b.printStackTrace=function(){});if(d==Error){if(0>(""+b).indexOf("Error"))return!1;System.out.println(a.getStackTrace());return!0}return d==Exception||d==Throwable||d==NullPointerException&&c(b)};a.getStackTrace=function(a){a||
...
(s[0]=q.claxxOwner));if(!m.stacks||m.claxxReference!==c){++Q;m=function(){var c;a:{var d=arguments.callee.claxxReference,j=arguments.callee.methodName;c=arguments;fx=this[j];var h=a.getParamsType(c);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(n){}if(e){var r=d.__CLASS_NAME__+" "+j+" ";0>U.indexOf(r)&&(U+=r+"\n");e[r]||(e[r]=0);e[r]++}if(fx.lastParams==h.typeString&&fx.lastClaxxRef===d){if(h.hasCastedNull){d=[];for(j=0;j<c.length;j++)d[j]=c[j]instanceof a.CastedNull?null:c[j]}else d=c;
c=fx.lastMethod?fx.lastMethod.apply(this,d):null}else{fx.lastParams=h.typeString;fx.lastClaxxRef=d;r=fx.stacks;r||(r=d.prototype[j].stacks);for(var k=!1,l=r.length;0<=--l;)if(k||r[l]===d){var m=r[l].prototype[j],z=h,k=c,q=fx,s=[],t=!0,F=void 0;for(F in m)if(92==F.charCodeAt(0)){var u=F.substring(1).split("\\");u.length==z.length&&s.push(u);t=!1}else if(t&&"funParams"==F&&m.funParams){F=m.funParams;u=F.substring(1).split("\\");u.length==z.length&&(s[0]=u);break}F=void 0;if(!(F=0==s.length)){F=void 0;
for(var F=[],P=s.length,u=0;u<P;u++){for(var x=[],za=!0,C=s[u].length,B=0;B<C;B++)if(x[B]=a.getInheritedLevel(z[B],s[u][B]),0>x[B]){za=!1;break}za&&(x[z.length]=u,F.push(x))}if(0==F.length)F=null;else{P=F[0];for(u=1;u<F.length;u++){x=!0;for(B=0;B<z.length;B++)if(P[B]<F[u][B]){x=!1;break}x&&(P=F[u])}F=s[P[z.length]].join("\\")}F=!(s=F)}if(F)k=new b;else{m=t?m:m["\\"+s];t=null;if(z.hasCastedNull){t=[];for(z=0;z<k.length;z++)t[z]=k[z]instanceof a.CastedNull?null:k[z]}else t=k;q.lastMethod=m;k=m.apply(this,
t)}if(!(k instanceof b)){c=k;break a}k=!0}"construct"!=j&&fb(this,d,j,h.typeString);c=void 0}}return c};m.methodName=d;m.claxxReference=c;m=l[d]=m;d=[];for(l=0;l<s.length;l++)d[l]=s[l];m.stacks=d}s=m.stacks;0>rb(s,c)&&s.push(c);q&&(q.claxxOwner===c?(m[q.funParams]=q,q.claxxOwner=null,q.funParams=null):q.claxxOwner||(m["\\unknown"]=q));h.exClazz=c;m[k]=h;return m};duplicatedMethods={};var E=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,
...
1);if(k[h])return k[h];k[h]=c}else{if(window[b])return window[b];a.setGlobal(b,c)}a.decorateAsType(c,b,d,e);b=a._innerFunctions;c.defineMethod=b.defineMethod;c.defineStaticMethod=b.defineStaticMethod;c.makeConstructor=b.makeConstructor;return c};var Fa=!1;-1!=navigator.userAgent.indexOf("Safari")&&(k=navigator.userAgent,q=k.indexOf("Version/"),-1!=q&&(k=k.substring(q+8),Fa=4<=parseFloat(k)));a.instantialize=function(a,b){if(!b||!(1==b.length&&b[0]&&b[0]instanceof t)){a instanceof Number&&(a.valueOf=
...
d,!0,e,1)};b.loadClass=function(c,f,h,k,l){l||(l=0);null==k&&(k=!1);if("boolean"==typeof f)return a.evalType(c);null!=window["java.registered"]&&!D["@java"]&&b.loadPackage("java");b.keepOnLoading=!0;if(!h&&(I&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(da)))La.push([c,f]),System.out.println("loadclass-queuing"+c+da+" "+isClassDefined(da));else if((l=isClassDefined(c))||O["@"+c]){if(l&&f&&(h=H(c),!h||h.status>=x.STATUS_LOAD_COMPLETE))k?window.setTimeout(f,25):f()}else{var m=
b.getClasspathFor(c);l=e[m];if(!l)for(k=E.length;0<=--k;)if(E[k].path==m||E[k].name==c){l=!0;break}if(l){if(f&&(l=H(c)))if(l.onLoaded){if(f!=l.onLoaded){var r=l.onLoaded,q=f;l.onLoaded=function(){r();q()}}}else l.onLoaded=f}else{l=a.unloadedClasses[c]&&H(c)||new x;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;X(m,c,l);l.onLoaded=f;l.status=x.STATUS_KNOWN;c=!1;for(k=E.length;0<=--k;)if(E[k].status!=x.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=E.length;0<=--k&&!E[k].isPackage;)E[k+
1]=E[k];E[++k]=l}else c&&E.push(l);if(!c){var s=!1;f&&(s=ha,ha=!0);h&&(f=null);Ja(d,l,!0);V(l,l.path,l.requiredBy,!1,f?function(){ha=s;f()}:null)}}}};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=function(a,b){b instanceof Array||(b=[b]);C(b);m._debugCore&&(a=a.replace(/\.z\./,"."));for(var c=b.length;0<=--c;)D["#"+b[c]]=a;D["$"+a]=b};b.registerPackages=function(c,d){for(var e=
b.getClasspathFor(c+".*",!0),f=0;f<d.length;f++)window.Clazz&&a.declarePackage(c+"."+d[f]),b.loadPackageClasspath(c+"."+d[f],e)};b.getClasspathFor=function(c,d,e){var f=D["#"+c];if(!f||d||e){var h,k;if(f){if(c=c.replace(/\./g,"/"),0<=(k=f.lastIndexOf(c))||0<=(k=c.lastIndexOf("/"))&&0<=(k=f.lastIndexOf(c.substring(0,k))))h=f.substring(0,k)}else{for(k=c.length+2;0<=(k=c.lastIndexOf(".",k-2))&&!(h=D["@"+c.substring(0,k)]););d||(c=c.replace(/\./g,"/"))}null==h&&(h=window.Clazz&&a.binaryFolders&&a.binaryFolders.length?
...
d,f,k,l){a.currentPath=d;k&&alert("WHY>>");k=e[d];e[d]=!0;Ya(E,d);M=!0;sa=!1;b._checkLoad&&System.out.println("\t"+d+(f?"\n -- required by "+f:"")+"  ajax="+M+" async="+sa);f=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));k||System.out.println("loadScript "+d);b.onScriptLoading(d);if(M&&!sa){var r=m._getFileData(d);try{U(d,f,r,k)}catch(q){alert(q+" loading file "+d+" "+c.name+" "+a.getStackTrace())}l&&l()}else c={dataType:"script",async:!0,type:"GET",url:d,success:ua(d,!1,l),error:ua(d,!0,l)},h++,
...
!1;r=document.getElementsByTagName("SCRIPT");for(q=0;q<r.length;q++)if(s){if(r[q].onreadystatechange&&r[q].onreadystatechange.path==l.path&&"interactive"==r[q].readyState){m=!0;break}}else if(r[q].onload&&r[q].onload.path==l.path){m=!0;break}m||(l.status=x.STATUS_CONTENT_LOADED,updateNode(l))}if(b.keepOnLoading){q=!0;if(m=Ka(x.STATUS_KNOWN))for(S(m);h<k&&(m=Ka(x.STATUS_KNOWN));)S(m);else if(0!=E.length)m=E.shift(),!e[m.path]||0!=E.length||!ha||m.musts.length||m.optionals.length?(Ja(d,m,!0),V(m,m.path,
m.requiredBy,!1)):ha&&(ha=!1);else if(m=G(x.STATUS_KNOWN))for(S(m);h<k&&(m=G(x.STATUS_KNOWN));)S(m);else q=!1;if(!(q||0<h)){l=[Ka,G];r=null;for(q=0;2>q;q++)for(;m=l[q](x.STATUS_CONTENT_LOADED);)1==q&&r===m&&(m.status=x.STATUS_LOAD_COMPLETE),updateNode(m),r=m;for(;!(ma=[],!na(d,c)););for(q=0;2>q;q++)for(r=null;(m=l[q](x.STATUS_DECLARED))&&r!==m;)updateNode(r=m);r=[];for(q=0;2>q;q++)for(;m=l[q](x.STATUS_DECLARED);)r.push(m),m.status=x.STATUS_LOAD_COMPLETE;if(r.length){for(q=0;q<r.length;q++)Da(r[q]);
...
a=("undefined"==typeof a?"":null==a?"null":""+a).replace(/\t/g,V);if(0<a.length)switch(a.charAt(a.length-1)){case "\n":case "\r":a=1<a.length?a.substring(0,a.length-("\r"==a.charAt(a.length-2)?2:1)):"",e=!0}var h=null;a=a.replace(/\t/g,V);for(var h=a.split(/\r\n|\r|\n/g),d=0,k=h.length-1;d<=k;d++){var l=null;if(C.metLineBreak||0==C.linesCount||1>c.childNodes.length)l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",C.linesCount++;else try{l=c.childNodes[c.childNodes.length-
...
function(a){C.consoleOutput(a,"red")};ba.err.println=function(a){C.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};ba.err.write=function(a,b,c){ba.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2019-05-01 20:42:55 -0500 (Wed, 01 May 2019) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.29.42";
